...
class EnvoyGatherService_createItem extends ServiceHook{
	...
	public Object onPreExecute(Object input) {
		log.info("Hooks EnvoyGatherService_createItem onPreExecute logging.version: $hookVersion")
		GatherableDTO e = (GatherableDTO) input
		//int panjang = 
		int i = 0;
		//for (i=0;i<e.length;i++){
			List<Attribute> custAttribs = e.getCustomAttributes()
	...
	public Object onPostExecute(Object input, Object result) {
		log.info("Hooks EnvoyGatherService_createItem onPostExecute logging.version: ${hookVersion}")
