...
class RequisitionService_modifyHeader extends ServiceHook{
	...
	public Object onPreExecute(Object input) {
		log.info("Hooks RequisitionService_modifyHeader onPreExecute logging.version: ${hookVersion}")
				
		RequisitionServiceModifyHeaderRequestDTO e = (RequisitionServiceModifyHeaderRequestDTO) input ;
		projA = "";
		projB = "";
		projA = e.getProjectA();
		projB = e.getProjectB();
