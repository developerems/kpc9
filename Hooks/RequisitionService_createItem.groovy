...
class RequisitionService_createItem extends ServiceHook{
	...
	public Object onPreExecute(Object input) {
		log.info("Hooks RequisitionService_createItem onPreExecute logging.version: ${hookVersion}")

		RequisitionServiceCreateItemRequestDTO e = (RequisitionServiceCreateItemRequestDTO) input ;
		...
		for (i = 0 ; i < c.length ; i++) {
			...
			if (!stk.equals("")) {
				if(!ireqType.equals(null)){
					if(!ireqType.equals("NM")){
