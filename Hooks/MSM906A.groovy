...
public class MSM906A extends MSOHook{
	...
	public GenericMsoRecord onPreSubmit(GenericMsoRecord screen){
		...
		workOrdProj1 = screen.getField("WORK_PROJ1I1").getValue();
		wpInd1 = screen.getField("WORK_PROJ_IND1I1").getValue();
		workOrdProj2 = screen.getField("WORK_PROJ1I2").getValue();
		wpInd2 = screen.getField("WORK_PROJ_IND1I2").getValue();
		workOrdProj3 = screen.getField("WORK_PROJ1I3").getValue();
		wpInd3 = screen.getField("WORK_PROJ_IND1I3").getValue();
		workOrdProj4 = screen.getField("WORK_PROJ1I4").getValue();
		wpInd4 = screen.getField("WORK_PROJ_IND1I4").getValue();
