...
public class MSM24CA extends MSOHook{
	...
	public GenericMsoRecord onDisplay(GenericMsoRecord screen){
		log.info("Hooks onDisplay MSM24CA logging.version: ${hookVersion}");
		
		return null;
	}
	@Override
	public GenericMsoRecord onPreSubmit(GenericMsoRecord screen){
		log.info("Hooks onPreSubmit MSM24CA logging.version: ${hookVersion}");
		String STOCK = screen.getField("STOCK_CODE1I").getValue().trim();
		String RO_NO = screen.getField("RO_NUM1I").getValue().trim();
